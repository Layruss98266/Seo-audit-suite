...
const NAV_ITEMS: NavItem[] = [
  ...
  // Ported stateless SEO-Suite utilities (schema/robots generators, structured
  // data validation, page-type detection, keyword research) live under /tools.
  { href: "/tools", icon: ZapIcon, label: "Tools" },
